...
public class AppUsageManager {
    ...
    private static Map<String, AppInfo> trackedApps = new HashMap<String, AppInfo>();
    ...
    public static AppInfo[] getApps(){
        AppInfo[] apps = trackedApps.values().toArray(new AppInfo[0]);
        return apps;
    }
     ...
     */
    public static AppInfo addApp(Context context, String packageName){
        ...
        try {
            ...
            appInfo = new AppInfo(app, name, icon);
     ...
     */
    public static void removeMap(String packageName){
